<?php
/* Smarty version 4.1.0, created on 2022-06-08 23:19:05
  from 'C:\xampp\htdocs\library\app\Views\Auth\reset_password.tpl' */

/* @var Smarty_Internal_Template $_smarty_tpl */
if ($_smarty_tpl->_decodeProperties($_smarty_tpl, array (
  'version' => '4.1.0',
  'unifunc' => 'content_62a174b9cb24b7_90726533',
  'has_nocache_code' => false,
  'file_dependency' => 
  array (
    'da882214a7e210fe6a0cb3040171a27119bc8455' => 
    array (
      0 => 'C:\\xampp\\htdocs\\library\\app\\Views\\Auth\\reset_password.tpl',
      1 => 1654748342,
      2 => 'file',
    ),
  ),
...
function content_62a174b9cb24b7_90726533 (Smarty_Internal_Template $_smarty_tpl) {
?><!DOCTYPE html>
<html lang="zxx">
<head>
					...
					<div class="details">
						...
						<form method="POST">
							<div class="form-group form-box">
								<input type="email" name="email" class="form-control" placeholder="Email Address" aria-label="Email Address" value="<?php echo $_smarty_tpl->tpl_vars['user']->value['email'];?>
" readonly required>
							</div>
							<div class="form-group form-box">
								<input type="password" name="password" class="form-control" autocomplete="off" placeholder="New Password" aria-label="New Password" required>
							</div>
							<div class="form-group form-box">
								<input type="password" class="form-control" autocomplete="off" placeholder="Repeat Password" aria-label="Repeat Password" required>
							</div>
